...
@Component({
    ...
    <div [routerLink]="['/events',event.id]" class="well hoverwell thumbnail">
        <h2>{{event.name | uppercase}}</h2>  <!--removed event? because it is assured to be IEvent type-->
        ...
        <div>Price : {{event.price | currency:'USD'}}</div> <!-- \ used to escape the special character-->
